/* src/PNotifyDesktopComponent.html generated by Svelte v3.18.2 */
...
function instance($$self, $$props, $$invalidate) {
	...
	function genNotice() {
		...
		const desktopOptions = { body: text || self.text, tag: _tag };
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*desktop*/ 2) {
			$: $$invalidate(12, _enabled = _permission && desktop);
		}

		if ($$self.$$.dirty & /*self, _enabled, _oldAnimation*/ 4609) {
			$: {
				if (self.animation !== "none") {
					$$invalidate(9, _oldAnimation = self.animation);
				}
	...
	return [self, desktop, fallback, icon, tag, title, text, options];
}
