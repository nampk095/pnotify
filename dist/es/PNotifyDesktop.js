/* src/PNotifyDesktop.svelte generated by Svelte v3.18.2 */
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*self, _oldAnimation*/ 257) {
			$: {
...
class PNotifyDesktop extends SvelteComponent {
	constructor(options) {
		super();
...
export { position, defaults, requestPermission as permission };
